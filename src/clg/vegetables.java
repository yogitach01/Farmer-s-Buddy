...
import java.awt.*; 
import javax.swing.*; 
public class vegetables extends JFrame implements ActionListener {
	JFrame f;
	 JLabel l,im;
	 JComboBox c1;
...
if(c1.getSelectedItem()=="onion") {
	ta.setText(" Storage\r\n"
		...
		if(e.getSource()== m)
		{
			if(c1.getSelectedItem()=="potato") {
				try {
					Desktop.getDesktop().open(new java.io.File("File/potato.txt"));	
...
if(c1.getSelectedItem()=="onion") {
	try {
		Desktop.getDesktop().open(new java.io.File("File/onion.txt"));	
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}			}
if(c1.getSelectedItem()=="tomato") {
	try {
		Desktop.getDesktop().open(new java.io.File("File/tomato.txt"));	
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}	
